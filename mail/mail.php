...
$sendingAccountUsername     = 'vivek@mvivere.com';
$sendingAccountPassword     = 'Chewt!123';

// Recipient (To:) Details  - Change this to the email details of who will receive all the emails from the website.
$recipientEmail             = 'manish@colorblindlabs.com'; // REQUIRED value.
...
$websiteName                = 'Web Inquiry';                // REQUIRED value. This is used when a name or email is not collected from the website form
